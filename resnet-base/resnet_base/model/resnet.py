...
class ResNet(BaseModel):
    ...
    def _init_loss(self) -> None:
        ...
        self.logger_factory.add_scalar('loss', self.loss, log_frequency=4)
        self.logger_factory.add_scalar('cross_entropy_loss', cross_entropy_loss, log_frequency=16)
    ...
    def _init_accuracy(self) -> None:
        ...
        self.logger_factory.add_scalar('accuracy', self.accuracy, log_frequency=8)
