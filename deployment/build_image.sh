...
docker build -t gcr.io/$1/$MODEL_FOLDER:$MODEL_VERSION  --build-arg LOG_FOLDER_ARG=$MODEL_FOLDER-$MODEL_VERSION --build-arg BUCKET_NAME_ARG=$3 models/$MODEL_FOLDER
