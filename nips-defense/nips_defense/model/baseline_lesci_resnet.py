...
import os
from nips_defense.util.projection_metrics import projection_identity_accuracy
from nips_defense.model.baseline_resnet import BaselineResNet
...
from nips_defense.util.lesci_utils import lesci_layer
