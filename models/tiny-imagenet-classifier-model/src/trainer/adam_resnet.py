...
TF_LOGS = 'gs://{}'.format(os.path.join(os.environ.get('BUCKET_NAME'), 'model_data', os.environ.get('MODEL_ID'), 'tf_logs'))
SAVER_PATH = 'gs://{}'.format(os.environ.get('BUCKET_NAME'), 'model_data', os.environ.get('MODEL_ID'), 'checkpoint', TRAINING_RUN_NAME + "_model.ckpt")
